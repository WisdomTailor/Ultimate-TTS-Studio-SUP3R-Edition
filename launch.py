...
def init_voxcpm():
    ...
    try:
        ...
        return False, "❌ VoxCPM handler not available"
...
try:
    with suppress_specific_warnings():
        from indextts2_handler import (
            get_indextts2_handler,
            generate_indextts2_tts,
            init_indextts2,
            unload_indextts2,
            get_indextts2_status,
            check_indextts2_models,
            download_indextts2_models,
            EMOTION_PRESETS,
        )
...
def test_llm_connection(
    provider_name: str, base_url: str, api_key: str, model_id: str, timeout_seconds: int
):
